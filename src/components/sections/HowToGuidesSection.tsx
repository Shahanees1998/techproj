  ...
  const renderGuideItem = (guide: typeof guides[0], index: number) => {
    ...
    return (
      <div
        ...
        className={`border-t border-l border-r border-color px-5 py-5 border-top-l-radius ${isLast ? 'border-b' : ''}`}
      >
        <div
        ...
        >
          ...
          {isActive && (
            <p className="text-light font-normal family-poppins text-md mt-2">
              {guide.content}
            </p>
          )}
        </div>
