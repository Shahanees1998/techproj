        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-10 mt-16 sm-mt-0 sm-px-10 md:w-1/2 lg:w-1/2">
            <div className="wow fadeInUp group" data-wow-delay=".1s">
              ...
              <p className="mb-8 text-white font-normal family-poppins dark:text-dark-6 lg:mb-9 sm-center">
                Find, sell, fix, compare & learn about tech.
              </p>
              <div className="bg-white mt-12 mb-10 flex justify-between items-center rounded-full h-80">
                ...
                <button type="button" className="btn-gradient sm-none rounded-full px-5 mr-2 py-5"><img src="images/hero/search-icon.svg" /></button>
              </div>
