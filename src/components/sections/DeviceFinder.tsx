        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="w-full px-20 md:w-1/2 lg:w-8/12">
              ...
              <p className="text-white mb-5 family-poppins text-md font-normal">With TechFleet Membership, enjoy 24/7 priority tech care and repairs for just $9.99/month. Say goodbye to unexpected costs and hello to hassle-free support for all your devices.</p>
